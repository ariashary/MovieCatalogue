...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.ItemViewHolder> {
    ...
    public MoviesAdapter(List<Items> mData, OnItemsClickCallback callback) {
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View mView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.movie_row, viewGroup, false);
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(@NonNull View itemView) {
            super(itemView);
            imgPhoto = itemView.findViewById(R.id.img_photo_movies);
            tvName = itemView.findViewById(R.id.txt_name_movies);
            tvReleaseDate = itemView.findViewById(R.id.txt_releaseDate_movies);
            tvRating = itemView.findViewById(R.id.txt_rating_movies);
            tvDescription = itemView.findViewById(R.id.txt_description_movies);
